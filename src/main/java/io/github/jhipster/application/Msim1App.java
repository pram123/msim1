...
public class Msim1App {

    private static final Logger log = LoggerFactory.getLogger(Msim1App.class);

    private final Environment env;

    public Msim1App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Msim1App.class);
